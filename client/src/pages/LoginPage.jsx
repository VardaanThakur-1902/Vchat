...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-9 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl '>
      {/*-------left------- */}
      <img src={assets.logo} alt='' className='w-[min(30vm,250px)]' />
      {/*-------right------- */}
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        <button type='submit' className='py-3 bg-linear-to-r from-purple-400 to to-violet-600 text-white rounded-md cursor-pointer'>
